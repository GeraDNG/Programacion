...
public class Radio {
	...
	public static void main(String[] args) {
		...
		do{
			//Primero se necesitará encender el radio:
			if (encendido==false){
			...
			if (encendido==true){
				...
				if (s1.equals("B") || s1.equals("b")){
					...
					System.out.println("Cambio realizado a la estación: "+AUX);
				}
				//Opcion C:
